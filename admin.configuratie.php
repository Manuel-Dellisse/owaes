				...
				<form method="POST">
					...
					<fieldset>
						...
						<p>
							...
							<input type="radio" name="rbSMTP" id="rbSMTP" value="<? echo settings("mail", "smtp"); ?>" checked="<? echo (settings("mail", "smtp") == "TRUE") ? "checked" : ""; ?>"/>
						</p>
						<p>
						...
						<p>
							...
							<input type="radio" name="rbAuth" id="rbAuth" value="<? echo settings("mail", "SMTPAuth"); ?>" checked="<? echo (settings("mail", "SMTPAuth") == "TRUE") ? "checked" : ""; ?>"/>
						</p>
						<p>
